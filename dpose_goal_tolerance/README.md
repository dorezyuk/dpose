...
If true, Ipopt will use the Hessian generated by DposeCore.
On the current state this Hessian is very noisy due to discretization-errors.
Setting it to true is by now discouraged.
